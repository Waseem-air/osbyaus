...
@section('content')
    ...
    <div class="main-content">
                        ...
                        <div class="wrap-usa-vectormap">
                            ...
                            <div class="bot">
                                <div class="flex items-center justify-between gap20 mb-20">
                                    ...
                                    <div class="block-legend">
                                        <div class="dot t6"></div>
                                        <div class="text-tiny text-surface-2">Arizona <span class="fw-7 text-main-dark">15%</span>
                                        </div>
                                    </div>
                                    <div class="block-legend">
                                        <div class="dot t3"></div>
                                        <div class="text-tiny text-surface-2">Texas <span class="fw-7 text-main-dark">10%</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex items-center justify-between gap20">
                                    <div class="block-legend">
                                        <div class="dot t3"></div>
                                        <div class="text-tiny text-surface-2">Georda <span class="fw-7 text-main-dark">3.5%</span>
                                        </div>
                                    </div>
                                    <div class="block-legend">
                                        <div class="dot t3"></div>
        ...
        <div class="bottom-page">
            <div class="body-text">Copyright © 2024 <a href="../index.html">Ecomus</a>. Design by Themesflat All rights
                reserved
            </div>
        </div>
        <!-- /bottom-page -->
