...
(function ($) {
    ...
    /*----------------------------- Faq Block Toggle -------------------------------- */
    $(document).ready(function () {
        // Make sure the first FAQ item is open by default with the active class and minus icon
        $(".ec-faq-wrapper .ec-faq-block:first-child .ec-faq-title").addClass("active");

        // Show first FAQ content by default
        $(".ec-faq-wrapper .ec-faq-block:first-child .ec-faq-content").addClass("ec-faq-dropdown").show();

        // Show all FAQ content by default
        $(".ec-faq-wrapper .ec-faq-block .ec-faq-content").addClass("ec-faq-dropdown");

        // Toggle FAQ content and icon when clicked
        $(".ec-faq-block .ec-faq-title").click(function () {
            var $this = $(this).closest('.ec-faq-wrapper .ec-faq-block').find('.ec-faq-dropdown');

            // Toggle current FAQ content and icon
            $this.slideToggle('slow');
            $(this).toggleClass('active');

            // Close other FAQ contents and reset icons
            $('.ec-faq-dropdown').not($this).slideUp('slow');
            $('.ec-faq-title').not(this).removeClass('active');
        });
    });
    ...
    CartQtyPlusMinus.prepend('<div class="ec_cart_qtybtn"><div class="dec ec_qtybtn">-</div></div>');
    CartQtyPlusMinus.append('<div class="ec_cart_qtybtn"><div class="inc ec_qtybtn">+</div></div>');
    ...
    $(document).ready(function() {
        ...
        if (ecPopNewsLetter == "false" || !ecPopNewsLetter)
        {
            setTimeout( function(){ 
