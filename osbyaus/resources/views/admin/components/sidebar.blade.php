        ...
        <div class="center">
            <div class="center-item">
                <ul class="">
                    ...
                    <!-- Order Dropdown -->
{{--                    <li class="menu-item has-children {{ request()->routeIs('admin.order.*') ? 'active' : '' }}">--}}
{{--                        <a href="javascript:void(0);" class="menu-item-button">--}}
{{--                            <div class="icon">--}}
...
{{--                        </a>--}}
{{--                        <ul class="sub-menu" style="display: {{ request()->routeIs('admin.order.*') ? 'block' : 'none' }};">--}}
{{--                            <li class="sub-menu-item {{ request()->routeIs('admin.order.index') ? 'active' : '' }}">--}}
{{--                                <a href="{{ route('admin.order.index') }}" class="">--}}
{{--                                    <div class="text">Order List</div>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="sub-menu-item {{ request()->routeIs('admin.order.show') ? 'active' : '' }}">--}}
{{--                                <a href="{{ route('admin.order.show', 1) }}" class="">--}}
{{--                                    <div class="text">Order Detail</div>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="sub-menu-item {{ request()->routeIs('admin.order.tracking') ? 'active' : '' }}">--}}
