<?php $__env->startSection('content'); ?>
    ...
    <div class="main-content">
        ...
        <!-- Add Size Modal -->
        <?php echo $__env->make('admin.sizes.addSizeModal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <!-- Edit Size Modal -->
        <?php echo $__env->make('admin.sizes.editSizeModal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="main-content-wrap">
                <div class="flex items-center flex-wrap justify-between gap20 mb-30">
                    ...
                    <div class="flex items-center gap20">
                        <span class="body-text">Total Sizes: <?php echo e($sizes->count()); ?></span>
                    </div>
                </div>
                    ...
                    <div class="wg-table table-all-sizes">
                        ...
                        <div class="flex flex-column" id="sizesList">
                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="wg-product item-row gap20" id="size-<?php echo e($size->id); ?>">
                                    <div class="name">
                                        <div class="title line-clamp-2 mb-0">
                                            <a href="#" class="body-text  fw-bold"><?php echo e($size->name); ?></a>
                                        </div>
                                    </div>

                                    <div class="body-text">
                                        <span class="size-badge text-white"><?php echo e($size->short_code); ?></span>
                                    </div>
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input toggle-status"
                                            ...
                                            <?php echo e($size->is_active ? 'checked' : ''); ?>>
                                    </div>


                                    <div class="body-text text-main-dark"><?php echo e($size->created_at->format('M d, Y')); ?></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addSizeForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("admin.size.store")); ?>',
                    method: 'POST',
...
<?php echo $__env->make("admin.layout.main", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views\admin\sizes\index.blade.php ENDPATH**/ ?>