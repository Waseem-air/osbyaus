        ...
        <div class="main-content-inner">
            <div class="main-content-wrap">
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-4">
                            <div>
                                ...
                                <div class="flex items-center gap-4 flex-wrap">
                                    ...
                                    <div class="status-badge <?php echo e($product->status ? 'status-active' : 'status-inactive'); ?>">
                                        <i class="icon-<?php echo e($product->status ? 'check-circle' : 'x-circle'); ?>"></i>
                                        <?php echo e($product->status ? 'Active' : 'Inactive'); ?>

                                    </div>
                                    <div class="status-badge <?php echo e($product->stock_quantity > 0 ? 'status-instock' : 'status-outstock'); ?>">
                            ...
                            <div class="action-buttons">
                                <a href="<?php echo e(route('admin.product.index')); ?>" class="btn-icon" title="Back to Products">
                                    <i class="icon-arrow-left"></i>
                                </a>
                                <a href="<?php echo e(route('admin.product.edit', $product->id)); ?>" class="tf-button style-1" title="Edit Product">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-number"><?php echo e($product->stock_quantity); ?></div>
                        <div class="stat-label">Units in Stock</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number"><?php echo e($product->categories->count()); ?></div>
                        <div class="stat-label">Categories</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number"><?php echo e($product->colors->count()); ?></div>
                        <div class="stat-label">Colors</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number"><?php echo e($product->sizes->count()); ?></div>
                            ...
                            <div class="card-body">
                                <?php if($product->images->count() > 0): ?>
                                    <div class="gallery-card">
                                        <img src="<?php echo e(asset($product->mainImage ? $product->mainImage->image_path : $product->images->first()->image_path)); ?>"
                                        ...
                                        <div class="thumbnail-grid">
                                            <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <img src="<?php echo e(asset($image->image_path)); ?>"
                                                     alt="Product Image <?php echo e($loop->iteration); ?>"
                                                     class="thumbnail <?php echo e($image->is_main ? 'active' : ''); ?>"
                                                     onclick="switchMainImage(this, '<?php echo e(asset($image->image_path)); ?>')">
                            ...
                            <div class="card-body">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="info-card">
                                        ...
                                        <div style="color: var(--Heading); font-weight: 600; font-size: 16px;">
                                            <?php echo e($product->embellishment); ?>
                    ...
                    <div class="sidebar-area">
                        ...
                        <div class="price-card">
                            <div class="current-price">
                                <?php echo e(App\Helpers\AppHelper::currency_symbol()); ?><?php echo e(number_format($product->final_price, 2)); ?>

                            </div>
                            <?php if($product->discount_price): ?>
                                <div class="original-price">
                                    <?php echo e(App\Helpers\AppHelper::currency_symbol()); ?><?php echo e(number_format($product->price, 2)); ?>
                                ...
                                <div class="card-body">
                                    <div class="space-y-3">
                                        <?php $__currentLoopData = $product->colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productColor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($productColor): ?>
                                                <div class="color-tag">
                                                    <span class="color-dot" style="background-color: <?php echo e($productColor->hex_code); ?>;"></span>
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: 600; color: var(--Heading); font-size: 14px;">
                                                            Image <?php echo e($loop->iteration); ?>

                                                        </div>
                                                        <div style="color: var(--Note); font-size: 12px;">
                                                            <?php echo e($image->is_main ? 'Main Image' : 'Additional'); ?>

                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="image-actions">
                                                    <button class="image-action-btn set-main-btn <?php echo e($image->is_main ? 'disabled' : ''); ?>"
                                                            data-id="<?php echo e($image->id); ?>"
                                                        <?php echo e($image->is_main ? 'disabled' : ''); ?>>
                            ...
                            success: function(response) {
                                ...
                                if (response.status === 'success') {
                                    Swal.fire({
                                        ...
                                        window.location.href = '<?php echo e(route('admin.product.index')); ?>';
                                    });
                                } else {
                                    Swal.fire({
                                        title: 'Error!',
...
<?php echo $__env->make("admin.layout.main", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views\admin\products\show.blade.php ENDPATH**/ ?>