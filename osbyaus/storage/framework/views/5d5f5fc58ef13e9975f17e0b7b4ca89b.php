        ...
        <div class="main-content-inner">
            ...
            <div class="main-content-wrap">
                <div class="flex items-center flex-wrap justify-between gap20 mb-30">
                    <h3>Edit Product</h3>
                    <a href="<?php echo e(route('admin.product.show', $product->id)); ?>" class="tf-button style-2">
                ...
                <div class="row">
                                    ...
                                    <div class="existing-images mb-4">
                                        ...
                                        <div class="preview-container flex gap20 flex-wrap"
                                            ...
                                            <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="preview-item existing" data-image-id="<?php echo e($image->id); ?>">
                                                    ...
                                                    <div class="image-actions">
                                                        ...
                                                        <?php else: ?>
                                                            <button type="button" class="set-main-btn"
                                                                    data-id="<?php echo e($image->id); ?>" title="Set as Main">
                                                                <i class="icon-star"></i>
                                                            </button>
                                                        <?php endif; ?>
                                                        <button type="button" class="remove-existing-btn"
                                                                data-id="<?php echo e($image->id); ?>" title="Delete Image">
                    ...
                    <div class="col-lg-7 col-12">
                        <form id="editProductForm" class="form-edit-product" enctype="multipart/form-data"
                              action="<?php echo e(route('admin.product.update', $product->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="wg-box mb-30">
                                ...
                                <fieldset class="mb-4">
                                    ...
                                    <div class="tag-input-box" id="categoryInputBox">
                                        <span id="categoryPlaceholder"
                                              class="placeholder <?php echo e($product->categories->count() > 0 ? 'hidden' : ''); ?>">Select categories</span>
                                ...
                                <fieldset class="category mb-4">
                                    ...
                                    <input type="text" placeholder="Enter SKU" name="sku" class="form-control"
                                           value="<?php echo e($product->sku); ?>" required>
                                </fieldset>
                                ...
                                <fieldset class="mb-4">
                                    ...
                                    <div class="tag-input-box" id="sizeInputBox">
                                        <span id="sizePlaceholder"
                                              class="placeholder <?php echo e($product->sizes->count() > 0 ? 'hidden' : ''); ?>">Select sizes</span>
                                        <div class="selected-tags" id="selectedSizes">
                                            <?php $__currentLoopData = $product->sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productSize): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="tag">
                                                    <?php echo e($productSize->name); ?> (<?php echo e($productSize->short_code); ?>)
                                                    <button type="button"
                                                            onclick="this.parentElement.remove(); productForm.updatePlaceholder('selectedSizes');">
                                                        &times;
                                                    </button>
                                                    <input type="hidden" name="sizes[]" value="<?php echo e($productSize->id); ?>">
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <select id="sizeSelect">
                                            ...
                                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($size->id); ?>"
                                                        data-name="<?php echo e($size->name); ?> (<?php echo e($size->short_code); ?>)">
                                                    <?php echo e($size->name); ?> (<?php echo e($size->short_code); ?>)
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                ...
                                <fieldset class="mb-4">
                                    ...
                                    <div class="tag-input-box" id="colorInputBox">
                                        <span id="colorPlaceholder"
                                              class="placeholder <?php echo e($product->colors->count() > 0 ? 'hidden' : ''); ?>">Select colors</span>
                                        <div class="selected-tags" id="selectedColors">
                                            <?php $__currentLoopData = $product->colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productColor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="tag">
                                                    <div class="color-tag">
                                                        <span class="color-dot"
                                                              style="background-color: <?php echo e($productColor->hex_code); ?>;"></span>
                                                        <?php echo e($productColor->name); ?>
                                                    ...
                                                    <input type="hidden" name="colors[]"
                                                           value="<?php echo e($productColor->id); ?>">
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <select id="colorSelect">
                                            ...
                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($color->id); ?>" data-name="<?php echo e($color->name); ?>"
                                                        data-hex="<?php echo e($color->hex_code); ?>">
                                    ...
                                    <div class="col-md-4">
                                        <fieldset class="category">
                                            ...
                                            <input type="text" placeholder="Enter Fabric" name="fabric"
                                                   class="form-control" value="<?php echo e($product->fabric); ?>" required>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-4">
                                        <fieldset class="category">
                                            ...
                                            <input type="text" placeholder="Enter Embellishment" name="embellishment"
                                                   class="form-control" value="<?php echo e($product->embellishment); ?>" required>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-4">
                                        <fieldset class="category">
                                            ...
                                            <input type="text" placeholder="Enter Cut" name="cut" class="form-control"
                                                   value="<?php echo e($product->cut); ?>" required>
                                        </fieldset>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="category">
                                            ...
                                            <input type="number" step="0.01" placeholder="Enter Price" name="sale_price"
                                                   class="form-control" value="<?php echo e($product->discount_price); ?>">
                                        </fieldset>
                                    </div>
                                </div>
                                ...
                                <fieldset class="category mb-4">
                                    ...
                                    <input type="number" placeholder="Enter stock" name="stock_quantity"
                                           class="form-control" value="<?php echo e($product->stock_quantity); ?>" required>
                                </fieldset>
                                ...
                                <div class="status-toggle">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="status"
                                               value="active" <?php echo e($product->status ? 'checked' : ''); ?>>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        class ProductEditForm {
            constructor() {
                this.categories = <?php echo json_encode($categories, 15, 512) ?>;
                this.colors = <?php echo json_encode($colors, 15, 512) ?>;
                this.sizes = <?php echo json_encode($sizes, 15, 512) ?>;
                this.productId = <?php echo e($product->id); ?>;
                this.init();
            }
                ...
                form.addEventListener('submit', async (e) => {
                    ...
                    try {
                        ...
                        if (result.status === 'success') {
                            ...
                            setTimeout(() => {
                                window.location.href = '<?php echo e(route("admin.product.show", $product->id)); ?>';
                            }, 1500);
                        } else {
...
<?php echo $__env->make("admin.layout.main", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views\admin\products\editproduct.blade.php ENDPATH**/ ?>