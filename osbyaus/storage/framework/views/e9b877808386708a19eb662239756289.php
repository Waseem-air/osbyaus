        ...
        <div class="wg-table table-product-list">
            ...
            <ul class="flex flex-column">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="wg-product item-row gap20" data-product-id="<?php echo e($product->id); ?>" style="border-bottom: 1px solid var(--Stroke);">
                        <!-- Product Image & Name -->
                        <div class="name">
                            <div class="image">
                                <?php if($product->mainImage): ?>
                                    <img src="<?php echo e(asset($product->mainImage->image_path)); ?>"
                                         alt="<?php echo e($product->name); ?>">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('admin/admin-ecomus/images/products/product-1.jpg')); ?>"
                                         alt="No Image">
                                <?php endif; ?>
                            </div>
                            <div class="title line-clamp-2 mb-0">
                                <a href="<?php echo e(route('admin.product.show', $product->id)); ?>" class="body-text" style="color: var(--Body-Text);"><?php echo e($product->name); ?></a>
                                <p style="color: var(--Note);">SKU: <?php echo e($product->sku); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="size-display-group">
                            <?php $__currentLoopData = $product->colors->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productColor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($productColor): ?>
                                    <div class="size-display">
                                        <span class="color-circle"
                                              style="background-color: <?php echo e($productColor->hex_code); ?>; border: 2px solid var(--White); box-shadow: 0 0 0 1px var(--Stroke);"></span>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="size-display">
                                <p style="color: var(--Body-Text);">
                                    <?php $__currentLoopData = $product->sizes->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productSize): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($productSize): ?>
                                            <?php echo e($productSize->short_code); ?><?php if(!$loop->last): ?>
                                                /
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <nav class="pagination">
                    <ul class="flex items-center gap5">
                        ...
                        <li class="page-item <?php echo e($products->onFirstPage() ? 'disabled' : ''); ?>">
                            <a class="page-link" href="#" data-page="<?php echo e($products->currentPage() - 1); ?>"
                               <?php echo e($products->onFirstPage() ? 'tabindex="-1"' : ''); ?>
                        ...
                        <?php $__currentLoopData = $products->getUrlRange(1, $products->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $products->currentPage()): ?>
                                <li class="page-item active">
                                    <span class="page-link" style="background: var(--Secondary); color: var(--White); border: 1px solid var(--Secondary);"><?php echo e($page); ?></span>
                                </li>
                            <?php else: ?>
                                <li class="page-item">
                                    <a class="page-link" href="#" data-page="<?php echo e($page); ?>"
                                       style="background: var(--White); color: var(--Body-Text); border: 1px solid var(--Stroke);"><?php echo e($page); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="page-item <?php echo e(!$products->hasMorePages() ? 'disabled' : ''); ?>">
                            <a class="page-link" href="#" data-page="<?php echo e($products->currentPage() + 1); ?>"
                               <?php echo e(!$products->hasMorePages() ? 'tabindex="-1"' : ''); ?>
...
<?php else: ?>
    <div class="text-center py-5">
        ...
        <a class="tf-button style-1 w208" href="<?php echo e(route('admin.product.add')); ?>"
           style="background: var(--Secondary); color: var(--White); border: 1px solid var(--Secondary);">
            <i class="icon-plus"></i> Add First Product
        </a>
    </div>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views/admin/products/partials/product_list.blade.php ENDPATH**/ ?>