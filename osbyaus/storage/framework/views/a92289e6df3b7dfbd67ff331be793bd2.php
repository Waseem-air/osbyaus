<?php $__env->startSection('content'); ?>
    ...
    <div class="main-content">
        <?php echo $__env->make('admin.colors.addColorModal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('admin.colors.editColorModal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="main-content-wrap">
                <div class="flex items-center flex-wrap justify-between gap20 mb-30">
                    ...
                    <div class="flex items-center gap20">
                        <span class="body-text">Total Colors: <?php echo e($colors->count()); ?></span>
                    </div>
                </div>
                    ...
                    <div class="wg-table table-all-colors">
                        ...
                        <div class="flex flex-column" id="colorsList">
                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="wg-product item-row gap20" id="color-<?php echo e($color->id); ?>">
                                    <div class="name">
                                        <div class="title line-clamp-2 mb-0">
                                            <a href="#" class="body-text fw-bold"><?php echo e($color->name); ?></a>
                                        </div>
                                    </div>

                                    <div class="body-text text-main-dark"><?php echo e($color->hex_code); ?></div>

                                    <div class="body-text">
                                        <span class="color-preview" style="background-color: <?php echo e($color->hex_code); ?>;"></span>
                                    </div>
                                    <div>
                                    ...
                                    <div class="body-text text-main-dark"><?php echo e($color->created_at->format('M d, Y')); ?></div>

                                    <div class="item-actions">
                                        <a href="javascript:void(0)" class="edit-color" data-id="<?php echo e($color->id); ?>" data-bs-toggle="modal" data-bs-target="#editColorModal" title="Edit Color">
                                            <i class="icon-edit"></i>
                                        </a>
                                        <a href="javascript:void(0)" class="delete-color" data-id="<?php echo e($color->id); ?>" data-name="<?php echo e($color->name); ?>" title="Delete Color">
...
<?php echo $__env->make("admin.layout.main", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views\admin\colors\index.blade.php ENDPATH**/ ?>