                                    ...
                                    <div class="tag-input-box" id="sizeInputBox">
                                        ...
                                        <select id="sizeSelect">
                                            ...
                                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($size->id); ?>" data-name="<?php echo e($size->name); ?> (<?php echo e($size->short_code); ?>)">
                                    ...
                                    <div class="tag-input-box" id="colorInputBox">
                                        ...
                                        <select id="colorSelect">
                                            ...
                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($color->id); ?>" data-name="<?php echo e($color->name); ?>" data-hex="<?php echo e($color->hex_code); ?>">
            ...
            handleFormSubmission() {
                ...
                form.addEventListener('submit', async (e) => {
                    ...
                    try {
                        ...
                        const response = await fetch('<?php echo e(route("admin.product.store")); ?>', {
                            method: 'POST',
                            headers: {
...
<?php echo $__env->make("admin.layout.main", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views/admin/products/addproduct.blade.php ENDPATH**/ ?>