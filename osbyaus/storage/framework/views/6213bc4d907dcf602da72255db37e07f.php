...
<div class="section-menu-left">
    <div class="box-logo">
        <a href="<?php echo e(route('admin.dashboard')); ?>" id="site-logo-inner">
            <img class="" id="logo_header" alt="" src="<?php echo e(asset('admin/logo/logo.png')); ?>"
        ...
        <div class="center">
            <div class="center-item">
                <ul class="">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo e(url('/admin/transaction')); ?>" class="">
                            <div class="icon">
                    ...
                    <!-- Customers -->
                    <li class="menu-item <?php echo e(request()->routeIs('admin.customers.*') || request()->routeIs('admin.customer.*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.customer.index')); ?>" class="">
                            <div class="icon"><i class="icon-users"></i></div>
                            <div class="text">Customers</div>
                        </a>
                    </li>

                    <li class="menu-item has-children <?php echo e(request()->routeIs('admin.product.*') ? 'active' : ''); ?>">
                        <a href="javascript:void(0);" class="menu-item-button">
                            <div class="icon"><i class="icon-file-plus"></i></div>
                            <div class="text">Product</div>
                        </a>
                        <ul class="sub-menu" style="display: <?php echo e(request()->routeIs('admin.product.*') ? 'block' : 'none'); ?>;">
                            <li class="sub-menu-item <?php echo e(request()->routeIs('admin.product.index') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.product.index')); ?>" class="">
                                    <div class="text">All Products</div>
                                </a>
                            </li>
                            <li class="sub-menu-item <?php echo e(request()->routeIs('admin.product.add') ? 'active' : ''); ?>">
                    ...
                    <!-- Categories -->
                    <li class="menu-item <?php echo e(request()->routeIs('admin.category.*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.category.index')); ?>" class="">
                    ...
                    <!-- Attributes Dropdown -->
                    <li class="menu-item has-children <?php echo e(request()->routeIs('admin.color.*') || request()->routeIs('admin.size.*') ? 'active' : ''); ?>">
                        <a href="javascript:void(0);" class="menu-item-button">
                            <div class="icon">
                        ...
                        <ul class="sub-menu" style="display: <?php echo e(request()->routeIs('admin.color.*') || request()->routeIs('admin.size.*') ? 'block' : 'none'); ?>;">
                            <!-- Colors -->
                            <li class="sub-menu-item <?php echo e(request()->routeIs('admin.color.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.color.index')); ?>" class="">
                                    <div class="text">Colors</div>
                                </a>
                            </li>

                            <!-- Sizes -->
                            <li class="sub-menu-item <?php echo e(request()->routeIs('admin.size.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.size.index')); ?>" class="">
...
<!-- /section-menu-left -->
<?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views\admin\components\sidebar.blade.php ENDPATH**/ ?>