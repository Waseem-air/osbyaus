...
<div class="search-bar-container mb-2 d-none d-md-flex">
    ...
    <!-- Clear Filters -->
    <a href="<?php echo e(route('admin.product.index')); ?>" class="tf-button style-2">
...
<div class="d-block d-md-none mb-2">
    <div class="row g-2">
        ...
        <!-- Row 2: Clear & Add -->
        <div class="col-6">
            <a href="<?php echo e(route('admin.product.index')); ?>" class="tf-button style-2 w-100">
                <i class="icon-refresh-cw"></i> Clear
            </a>
        </div>
        <div class="col-6">
...
<?php echo $__env->make("admin.layout.main", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views/admin/products/index.blade.php ENDPATH**/ ?>