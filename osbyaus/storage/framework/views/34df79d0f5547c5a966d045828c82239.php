     <!-- header-dashboard -->
                <div class="header-dashboard">
                    <div class="wrap">
                        <div class="header-left">
                            <a href="index.html">
                                <img class="" id="logo_header_mobile" alt="" src="<?php echo e(asset('admin/admin-ecomus/logo/logo.png')); ?>" data-light="..//admin/images/logo/logo.svg" data-dark="..//admin/images/logo/logo-white.svg">
                            </a>
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                        <span class="header-user wg-user">
                                            <span class="image">
                                                <img src="<?php echo e(asset('admin/admin-ecomus//admin/images/avatar/user-1.png')); ?>" alt="">                                            </span>
                                        </span>
                                    </button>
                ...
                <!-- /header-dashboard -->
<?php /**PATH C:\xampp\htdocs\2025_projects\osbyaus\osbyaus\resources\views\admin\components\header.blade.php ENDPATH**/ ?>